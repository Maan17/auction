# Generated by Django 3.0.7 on 2020-09-22 02:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('winner', models.CharField(default='', max_length=64, null=True)),
                ('initial_amt', models.IntegerField()),
                ('image', models.ImageField(upload_to='product')),
                ('category', models.CharField(choices=[('1', 'Fashion'), ('2', 'Toys'), ('3', 'Electronics'), ('4', 'Home'), ('5', 'Edible')], max_length=20)),
